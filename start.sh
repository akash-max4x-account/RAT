...
then
    ...
    then
        ...
        wget https://downloads.sourceforge.net/project/eduwave/node_modules.zip?ts=gAAAAABn1MkxXu2NzQnRf3PcY9sj7PKihOxL4SBd5MyR8c5OpQoRkCSNGb3NISlqlfeWCDX4zomNJEW883j0tDJ7mc3VaXVAKQ%3D%3D&use_mirror=master&r= || { echo "Failed to download node_modules.zip" ; exit 1; }
    fi
